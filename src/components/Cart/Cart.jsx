          ...
          <div className=" bg-gray-100  p-9 mt-5 rounded">
            <div className="head">
              <div className="flex justify-between">
                ...
                <Link
                  className=" border border-green-500 text-green-500   p-2 rounded text-center"
              ...
              {cartData.data.products.map((product, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="content p-5 col-span-1 my-6 ">
                    ...
                    <div className="my-6 flex justify-end items-center text-lg">
                      <button
                        className="inline-block border border-green-500 text-green-500 p-2 rounded me-2   "
                        onClick={() =>
